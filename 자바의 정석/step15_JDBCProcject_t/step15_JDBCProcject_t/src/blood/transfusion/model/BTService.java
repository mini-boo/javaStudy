...
public class BTService {
  ...
  //기존 BTProject 내용 수정
  	public boolean updateBTProjectPurpose(String btProjectId, String btProjectContent) throws SQLException, NotExistException{
  		notExistBTProject(btProjectId);
  		return BTProjectDAO.updateBTProjectPurpose(btProjectId, btProjectContent);
  	}
